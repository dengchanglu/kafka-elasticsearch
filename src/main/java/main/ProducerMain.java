...
public class ProducerMain {
    public static void main(String[] args) {
        ...
        final Producer producer = new Producer(ResourcesUtil.getConsumer("topic"));
        ...
        try {
            Channel channel = serverBootstrap.bind(ResourcesUtil.getNetty("netty.host"),
                    Integer.parseInt(ResourcesUtil.getNetty("port"))).sync().channel();
